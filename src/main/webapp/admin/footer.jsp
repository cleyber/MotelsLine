      ...
      <div class="row">
        ...
        <div class="col l4 offset-l2 s12">
          ...
          <ul class="valign-wrapper">
              ...
              <li><a class="grey-text text-lighten-3" href="#!"><img src="<%=Routes.getUrl("img/icons/youtube.png")%>"></a></li>
              <li><a class="grey-text text-lighten-3" href="#!"><img src="<%=Routes.getUrl("img/icons/google.png")%>"></a></li>
          </ul>
        </div>
      </div>
    </div>
